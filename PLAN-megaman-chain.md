...
> Đọc kèm `PLAN-hero-zephyr.md` — bảng thưởng dưới đây tính THEO plan đó (Reedwing thay
> Thornquill; Chardslam dời từ Armada sang Headliner), vì hai ô ấy đổi đúng vào giữa chuỗi.
...
ổ khoá đã mở. Ba hero đang được thiết kế theo luật ngược ấy (Thornshell, Gourdward, và
Thornquill đã nghỉ); phần còn lại của roster thì lại theo đúng R1 (Cornova, ba nguyên tố, và giờ
là Reedwing).
...
## 2 · Kiểm kê chín hồi (đã áp plan Reedwing)
...
|---|---|---|---|---|
| I-1 | **Gravehulk** 16hp/5dmg, miễn PUSH + massive — *thứ đầu tiên không đẩy được* | Snapmaw — Devour 7, xoá mọi thân dày trừ trùm | ✓ mồm khổng lồ đối mồm khổng lồ | ✗ **ĐỨT** — Snapmaw cận chiến, Ironcart lùi trên ray và bắn tầm 4 |
| I-2 | **Ironcart** 18hp, ray, standoff tối đa, nổ lan 1 — *đứng đúng chỗ không còn đủ* | Cornova — LOB qua đầu quân mình, Nova Shell = mất trọn lượt | ✓✓ sách giáo khoa: đoạt chính khẩu pháo | ✓✓ lob qua biển dung nham của Cinder, stun chặn vệt lửa một lượt |
...
| II-1 | **Armada** 22hp, FLYING, 3 túi khí, rơi xuống thành xác 4dmg — *tường có mặt sau, trời có sàn* | **Reedwing** — bay, move 4, 4 máu | ✓✓ đoạt bầu trời | ✓ bay + move 4 = đội hình không còn "lòng" để Sandreaver trồi lên; nhưng 4 máu đứng cạnh cú nổ 4 là chết |
| II-2 | **Sandreaver** 22hp, TELEPORT, trồi lên giữa đội hình — *tuyến không còn mặt trước* | Thornshell — taunt 3 ô, phản đòn 2, thân 10 máu | ✗ đây là **câu trả lời cho chính nó** | ✓✓ taunt kéo Frost Grip của Yeti vào cái thân 10 máu, và mỗi cú đập trả 2 |
...
| III-1 | **Headliner** 20hp/1dmg, gọi 4 vũ công mỗi hai lượt — *đám đông mới là mối đe doạ* | **Chardslam** — Vault Toss + Sweep bốn phía | ~ hất bay cả đám | ✓ Clockjaw KHÔNG miễn PUSH: hất 2 ô mỗi lượt thì nó không chạm được ai |
...
## 4 · ĐỀ XUẤT CHỐT: **giữ nguyên thứ tự và bảng mapping hiện tại (hậu-Reedwing)**
...
|---|---|---|---|---|
| 1 | Gravehulk | **Snapmaw** | mồm khổng lồ đối mồm khổng lồ | ⚠️ **GÃY** → sửa ở 5.2 |
| 2 | Ironcart | **Cornova** | đoạt chính khẩu pháo | lob qua biển lava + stun chặn vệt lửa |
| 3 | Cinder | **LỬA** | đoạt ngọn lửa | BURN tick trong lượt địch = một túi khí Armada, không tốn hành động |
| 4 | Armada | **Reedwing** | đoạt bầu trời | ⚠️ **MỜ** → sửa ở 5.3 |
| 5 | Sandreaver | **Thornshell** | nó chọn nơi trận đánh diễn ra — giờ anh chọn | taunt kéo Frost Grip vào thân 10 máu, mỗi cú đập trả 2 |
| 6 | Yeti | **BĂNG** | đoạt cái lạnh | **làm chậm hai lần = ĐÓNG BĂNG = Headliner mất lượt = cả một đợt bốn vũ công không bao giờ tới** |
| 7 | Headliner | **Chardslam** | nó không tự tay chạm vào ai; anh cũng vậy (`damage: 0`) | hất 2 ô mỗi lượt: con trùm ba-đòn-một-lượt không chạm được ai |
...
2. **Voltmaw phải đứng cuối** (26 máu, và Vết Nứt theo ngay sau) ⇒ ô 8 phải trả thứ trị được
   nó ⇒ ô 8 là Clockjaw (ward SHOCK). Ô 7 phải trả thứ trị được Clockjaw ⇒ Thornshell hoặc
   Chardslam.
3. **Snapmaw là phần thưởng DUY NHẤT không thể làm chìa khoá bằng kỹ năng của mình** — Devour bị
   làm cùn trước trùm *một cách cố ý* (`skillResolution.ts`, và `heroes.ts` giải thích: "phần
   thưởng cho việc hạ Gravehulk là đao phủ cho lính dày, không phải chìa khoá bỏ qua tám trận
   ...
   > sẽ mở lại bài toán tưởng là còn tự do. Snapmaw sau khi vá là **burst cận chiến cần một cửa sổ
...
**Phương án A — Gravehulk trả Thornshell, Sandreaver trả Snapmaw.**
R1 mạnh hơn ở cả hai ô: "thứ không đẩy được" → hero không thể bị dời và trừng phạt mọi va chạm;
và kỹ năng của Snapmaw *tên nội bộ đúng là* `burrow_strike`. R2 ô 1 cũng mạnh hơn hẳn: Provoke chạy
...
**Nhưng** Snapmaw dời tới ô 5 thì phải làm chìa cho **Yeti**: cận chiến lao vào con trùm giết bất kỳ
ai nó ghì, với kỹ năng vô dụng trước trùm — gãy nặng hơn chỗ vừa vá. Dời Snapmaw đi đâu cũng thế:
mọi ô 5-8 đều là trùm mà Devour không đụng tới được. **Loại.**

**Phương án B — Sandreaver đứng ô 7 (thay Headliner).**
Thornshell→Clockjaw là mắt R2 mạnh nhất game (code viết sẵn: *"THORNSHELL ANSWERS EVERY BEAT"*).
...
### 5.2 · Mắt xích đứt: Snapmaw không phải chìa của Ironcart — vá HAI đầu

Ironcart `attackRange: 4`, đi trên ray, và `railStandoff` **luôn lùi tới ô xa nhất mà vẫn còn
người trong vòng cung**. Snapmaw có move 3, cắn tầm 1, và Devour bị làm cùn trước trùm. Người chơi
cầm Snapmaw đi đánh Ironcart không có thêm một công cụ nào.
...
- Snapmaw là hero cận chiến **nhanh nhất** (move 3) và là thứ duy nhất xoá sạch hộ vệ chắn đường vào.
...
trên ray: cắn xong nó lùi ra tầm ≥2 rồi nã thẳng vào Snapmaw đang bất lực. Thứ khoá nó lại đã có
...
RAY rồi mới cắn**: một thân thể đặt trên đường lùi + Snapmaw áp sát = pháo không lùi được, không
bắn được, và ăn một cú cắn mỗi ba lượt. Đó là hình dạng đúng của trận này, và nó phải là câu
viết trong `hint`.

#### 5.2.b · Đầu Snapmaw: DEVOUR làm lại — xoá ngoại lệ, digest trả mỗi lần, thêm chảy máu
...
**Devour làm 1 sát thương lên trùm, giá 75 Sol** — và digest chỉ kích hoạt khi có `UNIT_DIE`,
tức trùm không chết thì cũng không phải trả downtime. Nút đắt nhất trong kit của Snapmaw **không
...
1. **Xoá hẳn dòng ngoại lệ. GIỮ NGUYÊN 7, không nâng thành "số to".** Repo đã đi con đường đó:
   ...
   *"thôi không còn chịu lực"*. Nâng số to trở lại là dựng lại đúng cái bẫy ấy ở tốc độ chậm.
   ...
   mạnh quá thì núm vặn là **độ dài digest** hoặc **giá Sol**, tuyệt đối không phải một ngoại lệ
   ...
   **Mốc 7 đã tra lại trên bảng số HIỆN TẠI** (đợt "giáp là kim loại, và chỉ kim loại" đã đổi
   Scrapcap từ giáp sang máu, nên phải kiểm chứ không tin comment cũ). Giáp trừ thẳng mỗi cú
   đánh (`gameLogic.ts:373`), ELITE nhân máu 1.5:

   | Thân dày nhất phe thường | Máu + giáp | Raw cần để xoá sổ |
   |---|---|---|
   | Linebreaker ELITE | floor(4×1.5)=6 **+ giáp 1** | **7** ← mốc |
   | Disco / Flag ELITE | 6, không giáp | 6 |
   | Pothelm ELITE | 4 + giáp 1 | 5 |
   | Scrapcap ELITE | 4, không giáp *(giáp đã bị lấy đi, máu 2→3)* | 4 |

   Linebreaker giữ nguyên cả 4 máu lẫn giáp 1 qua đợt rework, nên **mốc 7 vẫn đúng từng đơn vị**.
   **Devour 5 làm gãy đúng cái mốc ấy**: 5 vào Linebreaker elite = 4 sau giáp, nó SỐNG. Snapmaw thôi
   ...
   **downtime**, đó mới là đồng tiền đúng.
   ...
   Ăn theo miễn phí: `BLEEDING` cộng +1 **SAU bước trừ giáp** (plan Reedwing §8, cố ý như vậy để
   giáp không nuốt mất) — nên vết cắn của Snapmaw tự nó là một công cụ xuyên giáp, nằm ngay cạnh
   Xung Nam Châm trong cùng một khoảng thiết kế mà không giẫm lên nó (nam châm *lột hẳn* giáp,
...
2. **Digest trả mỗi lần bấm, nhưng ĐỘ DÀI theo việc đã xảy ra: nuốt trọn một thân = 2 lượt,
   ...
   khi tra `SUN_PER_TURN_INCOME = 25`: **75 Sol ĐÃ là ba lượt thu nhập nền**, tức giá Sol tự
   ...
   **Harvest của Sunbloom là 50 Sol/lượt.** Đội có cô là đội nuôi được một cú Devour MỖI LƯỢT —
   7 sát thương/lượt từ một hero, 49 qua bảy lượt, hơn thanh máu của bất kỳ con trùm nào. Giá
   Sol là cái van co giãn theo đội hình; **digest là cái van duy nhất không co giãn.**
...
3. **Devour gây `BLEEDING`.** `PLAN-hero-zephyr.md` §4 đã ghi gear Steel Jaws = món A
...
**R1 mạnh lên theo:** Gravehulk là **cú đánh đơn to nhất bàn cờ** (5 sát thương vào hero 6
máu). *"Giờ cú đánh to nhất là của bạn"* sắc hơn hẳn *"mồm to đối mồm to"*.

**Lỗ nó mở ra, phải chốt kèm:** recipe chữ ký `SNAPMAW:MAT_CHOMPER` (mỗi hero mở sẵn công
thức với cây gốc của mình, `SIGNATURE_MATERIAL`). Devour đã tự chảy máu thì fuse Snapmaw với chính
Steel Jaws thành **no-op**. Ô đó cần nghĩa mới — ứng viên: bleed lan sang **đòn cắn miễn phí**,
...
tắc, phải rà cùng lúc. Và `isMassive` được gán cho **mọi Gravehulk, kể cả lính thường**
(`encounterBuilder.ts:105`), nên bỏ ngoại lệ nghĩa là Gravehulk thường cũng ăn 7 thay vì 1 —
...
Cornova; Gravehulk thành hồi 2). Chuỗi sẽ đẹp hơn một chút (Nova Shell ghim đứng Gravehulk —
nó chỉ miễn PUSH, **không** miễn STUN), nhưng đổi lại phải viết lại phần mở màn của cả game,
trong khi Gravehulk là con trùm dạy luật "có thứ không đẩy được" và luật đó phải tới trước.

### 5.3 · Mắt mờ: Reedwing → Sandreaver — ✅ ĐÃ TRIỂN KHAI
...
Reedwing**, nên vị trí bắn của cô luôn nằm NGOÀI vòng nổ 4 ô — hình học súng chính là thứ giữ cái
...
nhiều như rào địch. Ô thứ hai là ô kề **phía người ném** — mây luôn nằm giữa Reedwing và thứ cô
...
một quả bom 50 Sol tắt được đợt vũ công của Headliner — tức Reedwing thành lời giải cho cả hồi
III-1. Bỏ `SPAWN` khỏi cửa: bốn nguồn triệu hồi (Headliner, echo của Blightlord, imp toss của
Gravehulk, `summon_backup`) đều sống qua khói.
...
| Tình huống | Kết quả |
|---|---|
| Reedwing (3,3) ném (3,5) | phủ (3,5) + (3,4) — ô thứ hai về phía cô ✓ |
| ném (1,3) | phủ (1,3) + (2,3) ✓ |
...
2. **Chardslam → Clockjaw.** Clockjaw không nằm trong `MASSIVE_BOSSES` nên hất được; Vault
...
|---|---|---|
| Sandreaver → **Thornshell** | "taunt là thứ nó không đào vòng qua được" | **Nó chọn nơi trận đánh diễn ra** — trồi lên đúng giữa đội hình bạn. Provoke là đúng quyền năng đó, đổi chủ: giờ *bạn* chọn chỗ, và mọi thứ trong 3 ô phải tới đó |
| Headliner → **Chardslam** | "một cây giáo xuyên cả hàng" (Thornquill, đã nghỉ) | **Nó không bao giờ tự tay chạm vào bạn** — nó biến kẻ khác thành mối đe doạ. Chardslam `damage: 0`: anh cũng không bao giờ tự tay gây một điểm sát thương nào, anh giết bằng chỗ kẻ địch rơi xuống. Hai kẻ thắng mà không đánh |
...
Phương án thay thế đã cân nhắc và **loại**: đảo Thornshell ↔ Gourdward (Clockjaw trả Thornshell —
...
2. **Hint của II-1 hứa dìm chết Armada** (*"take the hands that throw them into the sea"*) —
   viết cho Chardslam, mà Chardslam đã dời sang III-1. Bản thân Armada **miễn DROWN** khi còn
   bay và chỉ mất miễn nhiễm lúc rơi (`bossBehaviours.ts:1002-1015`), nên câu ấy vốn cũng chỉ
   đúng nửa. Plan Reedwing đã liệt việc viết lại hint này (§11) — chốt luôn nội dung mới theo
   khuôn ba vế của 5.4: *thổi bay túi khí ← LỬA từ chặng trước; đoạt lấy bầu trời ← Reedwing.*
...
| **Devour gây `BLEEDING`** (5.2.b) | `data/heroes.ts` effects + đường `BLEEDING` của plan Reedwing §8 | 1 effect |
| Recipe chữ ký `SNAPMAW:MAT_CHOMPER` hết nghĩa (5.2.b) | `data/fusionRecipes.ts` | 1 ô |
...
3. **Có cần mắt xích cho Reedwing → Sandreaver mạnh hơn không?** Hiện "đúng nhưng mờ", và Reedwing
...
5. **Nghĩa mới cho ô `SNAPMAW:MAT_CHOMPER`** (5.2.b): bleed lan sang đòn cắn miễn phí, hay
