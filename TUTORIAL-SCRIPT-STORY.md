# Kịch bản Tutorial Kể Chuyện — Blightfall: The Last Garden
...
* **Peaburst**: Trầm tĩnh, quyết đoán, người gánh vác tuyến đầu nhưng mang nỗi đau của kẻ sống sót.
* **Sunbloom**: Nhạy cảm, chan chứa hy vọng, từ một mầm sống yếu ớt dần trở thành trái tim năng lượng của đội.
...
| 7 | Peaburst bước lên, siết chặt khẩu súng đậu | Siết chặt mặt nạ. Nạp viên đạn đầu tiên. Peaburst dấn bước vào đêm đen. | `925` |
...
| `409` | L2 | Kẻ thù mới ở hàng trên. Bấm chọn Peaburst. | 8 |
...
| Dòng | Nhân vật | Lời thoại Kể chuyện |
|---|---|---|
| `72` | **Sunbloom** | *(Gia tăng hào quang, gật đầu)* Năng lượng đã hồi phục rồi! Lần này tôi sẽ không làm gánh nặng nữa! |
| `73` | **Peaburst** | Ghi nhớ này: Zombie không lang thang vô định. Chúng lao thẳng theo mùi hương của các CĂN NHÀ. |
| `74` | **Sunbloom** | *(Chỉ xuống đất)* Nhìn kìa... mấy cái hố đen ngòm nứt nẻ kia là sao? |
| `75` | **Peaburst** | Nơi lòng đất thối rữa đẻ ra quái vật. Đứng đè lên miệng hố là khóa chặt đường sống của chúng. Đi thôi! |
...
| `554` | L1 | Zombie xông vào hàng bạn. Bấm chọn Peaburst! | 7 |
| `555` | L1 | Chuẩn bị đạn: Bắn Đậu. | 4 |
| `556` | L1 | Nhắm chuẩn. Giữ nguyên hàng C! | 5 |
| `559` | L1 | Miệng hố đất rung lắc. Bấm chọn Sunbloom! | 7 |
| `560` | L1 | Bước đè lên hố đất. Bịt lối chui! | 7 |
| `561` | L1 | Gió im lặng. Kết thúc lượt. | 5 |
| `564` | L2 | Miệng hố đã bịt kín. Bấm chọn Sunbloom! | 7 |
| `565` | L2 | Thu Hoạch cần ĐỨNG YÊN. Giữ chặt miệng hố! | 8 |
| `566` | L2 | Kích hoạt năng lượng: Bấm vào Sunbloom. | 6 |
| `567` | L2 | Tên gầy ngoài rìa. Bấm chọn Peaburst! | 6 |
| `568` | L2 | Sẵn sàng đạn: Bắn Đậu. | 4 |
| `569` | L2 | Khai hỏa! | 2 |
| `570` | L2 | Nạp đầy 50 Sol. Kết thúc lượt. | 6 |
| `577` | L3 | Sunbloom kẹt lại rồi. Tiếp tục gom nắng! | 7 |
| `578` | L3 | Thu Hoạch năng lượng. | 3 |
| `579` | L3 | Chạm vào Sunbloom. | 3 |
| `580` | L3 | Peaburst nghiến răng: "Dồn hết đạn cho tôi!" | 7 |
| `581` | L3 | Bắn Chuẩn Xác: 50 Sol, xuyên thủng toàn hàng! | 8 |
| `582` | L3 | Bắn dọc hàng C. Quét sạch cả bốn tên! | 8 |
| `583` | L3 | Màn đêm sụp xuống. Kết thúc lượt. | 6 |
| `595` | L4 | Bị bao vây ba phía. Peaburst không lùi! | 7 |
| `596` | L4 | Nạp phát đạn cuối: Bắn Đậu. | 5 |
| `597` | L4 | Bắn ngã thêm một tên! | 4 |
| `598` | L4 | Quân địch quá đông. Sunbloom bất lực. Hãy thử! | 8 |
...
| `80` | **Sunbloom** | *(Gục đầu, nghẹn ngào)* ...Peaburst... cô ấy đã ngã xuống để bảo vệ cháu... |
...
| `83` | **Sunbloom** | Cháu... cháu tiêu hết chỗ Xu này để mua sạch đồ được không? |
...
| Dòng | Lượt | Lời hướng dẫn kịch tính (≤ 15 từ) | Số từ |
|---|---|---|---|
| `622` | SHOP | Thành hàng trống chỗ. Mua một Súng Hạt! | 8 |
| `623` | SHOP | Ghế dự bị còn chỗ. Mua thêm một Xạ Thủ! | 9 |
| `624` | SHOP | Kệ dưới là đồ một lần. Mua Mìn Hạt! | 9 |
...
| Dòng | Nhân vật | Lời thoại Kể chuyện |
|---|---|---|
| `87` | **Sunbloom** | *(Bước đi trên tàn tích, ôm chậu cây dự bị vừa mua, nghẹn ngào)* Peaburst mất rồi... một mình tôi làm sao tiếp tục hành trình này đây... |
| `88` | **Ironhusk** | *(Bước ra từ hốc đá nứt, cắm phập tấm khiên thép xuống đất)* Cô không đi một mình đâu, nhóc ạ. |
| `89` | **Sunbloom** | *(Giật mình ngước nhìn)* Anh... anh là Ironhusk! Anh cũng thoát khỏi đợt tấn công ở Quảng trường sao?! |
...
| `91` | **Sunbloom** | *(Lau nước mắt, ánh mắt kiên định hơn)* Cảm ơn anh... Nhưng nhìn kìa! Ba tên quái vật đang dồn vào hai căn nhà ở hai hướng... mình không thể cứu cả hai! |
...
| `94` | **Sunbloom** | Còn quả **Mìn Hạt** mua từ xe hàng lão Mulch — gài xuống đất, kẻ nào giẫm lên sẽ nổ tung. Phải dành riêng cho con trâu nhất! |
...
| `721` | L1 | Gài Mìn Hạt chặn bước nó quay lại. | 8 |
...
| `742` | L2 | Sunbloom tích nắng cho đòn quyết định. Chọn cô! | 8 |
| `743` | L2 | Thu Hoạch. | 2 |
...
| `759` | L3 | Zombie trồi từ mồ! Sunbloom, đốt ngay! | 6 |
...
| `98` | **Sunbloom** | *(Kinh ngạc)* Thời gian...? Cô có thể đảo ngược quá khứ sao? |
...
| `100` | **Sunbloom** | Đây là... một sự lựa chọn? Nếu chúng cháu chọn sai thì sao? |
...
| `782` | EVENT | Gọi người xưa trở lại: Chọn Peaburst! | 6 |
...
| `106` | **Peaburst** | *(Từ trong bước ra, xoa cổ tay)* ...Tôi... tôi đã bỏ lỡ điều gì sao? |
| `107` | **Sunbloom** | *(Oà khóc chạy đến)* SHADELEAF!! Cậu... cậu thực sự đã trở về từ cõi chết! |
...
| `109` | **Peaburst** | Hợp nhất... nghĩa là linh hồn cây dự bị sẽ hòa làm một với tôi? |
...
| `813` | CAMPFIRE | Chọn người nhận sức mạnh: Peaburst tái sinh! | 7 |
...
| `115` | **Gravehulk** | *(Tiếng gầm văng vẳng xé rách màng nhĩ)* GRAAAAAAAAAAAAHHH! |
| `116` | **Peaburst** | *(Giơ súng, tay run nhẹ)* Hai mươi đơn vị sinh lực... Một quái vật khổng lồ... Chúng ta không thể hạ gục nó! |
...
| `916` | L1 | Nó rầm rộ vào hàng D. Chọn Peaburst! | 7 |
| `917` | L1 | Bắn Đậu! | 2 |
| `918` | L1 | Xả đạn từ xa. 20 máu — bào dần! | 7 |
| `919` | L1 | Ironhusk làm mồi nhử. Bấm chọn anh ấy! | 7 |
| `920` | L1 | Đi hàng C né làn đạn của Peaburst! | 7 |
| `921` | L1 | Sunbloom tích nắng dồn đòn chí mạng. | 6 |
| `922` | L1 | Thu Hoạch. | 2 |
...
| `933` | L2 | Hai nhà sắp sụp. Chọn Peaburst dồn lực! | 7 |
| `934` | L2 | Bắn Chuẩn Xác! | 3 |
| `935` | L2 | Trút 50 Sol vào ngực nó! | 5 |
| `936` | L2 | Sunbloom, tích thêm năng lượng! | 4 |
| `937` | L2 | Thu Hoạch. | 2 |
...
| `948` | L3 | Sunbloom tung đòn cuối. Chọn cô ấy! | 6 |
| `949` | L3 | Thiêu Đốt — 50 Sol! | 4 |
| `950` | L3 | Nướng cháy nó! | 3 |
| `951` | L3 | Peaburst, trút nốt viên đạn cuối! | 5 |
| `952` | L3 | Bắn Đậu! | 2 |
| `953` | L3 | Tất cả đã dốc hết. Nó vẫn đứng! | 7 |
| `954` | L3 | Không thể cứu vãn. Thua là trắng tay! | 7 |
| `959` | L4 | Hết Sol, hết hy vọng. Nhìn nó tàn phá! | 8 |
